...
void onCommand(CRules@ rules, u8 cmd, CBitStream @params)
{
    if (cmd == rules.getCommandID(tag_cmd_id) && isServer())
    {
        ...
        bool player_allowed_to_use = playerAllowedToUse(player.getUsername());
        if (!player_allowed_to_use) return;
...
void onTick(CRules@ this)
{
    ...
    if (true)
    {
        ...
        if (time_since_last_tag >= tag_cooldown && (
                !getRules().get_bool(p.getUsername() + "is_tag_muted") ||
                p.isMod() ||
                playerAllowedToUse(p.getUsername())
            )
        ) {
...
bool playerAllowedToUse(string username) {
    // Gruhsha Trusted Players
    if (username == "TerminalHash") {
        ...
        return true;
    } else if (username == "GoldenGuy") {
        return true;
    } else if (username == "QuickToast") {
        return true;
    } else if (username == "Gizmodious") {
        return true;
    } else if (username == "NoahTheLegend") {
        return true;
    } else if (username == "daniilkulik32") {
        return true;
        ...
        return true;
    } else if (username == "vladkvs193") {
        return true;
    } else if (username == "Korvo0") {
        return true;
    } else if (username == "yavuzalanya99") {
        return true;
    } else if (username == "TheCustomerMan") {
        return true;
    } else if (username == "rimgonik") {
        return true;
    } else if (username == "Dr_Verycool") {
        return true;
    } else if (username == "petgreendino") {
        return true;
    } else if (username == "dredonkey") {
        return true;
    } else if (username == "lilya04") {
        return true;
    ...
    // Trusted Players
        ...
        return true;
    } else if (username == "Eluded") {
        return true;
    } else if (username == "HomekGod") {
        return true;
    } else if (username == "_Mike_") {
        return true;
